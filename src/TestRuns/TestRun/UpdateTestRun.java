...
public class UpdateTestRun extends Initialization{
    ...
    public Map<String, String> getTestRunsList(String auth_token, String token) throws IOException, JSONException {
    ...
    public Map<String, String> updateIncludeAllTestCases(String token, String auth_token, String test_run_id, Integer test_plan_id,
        ...
        String result = bodyResponse.body().string();
        if (result!=null){
            Map<String, String> test_run1 = new GetResponse().getMapStringFromJSON(result, "id", "title");
            return test_run1;
        }else {
            System.out.println("Something went wrong");
            return null;
    ...
    public Map<String, String> updateSelectTestCases(String token, String auth_token, String test_run_id,
        ...
        String result = bodyResponse.body().string();
        if (result!=null){
            Map<String, String> test_run2 = new GetResponse().getMapStringFromJSON(result, "id", "title");
            return test_run2;
        }else {
            System.out.println("Something went wrong");
            return null;
