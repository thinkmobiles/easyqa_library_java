...
public class UpdateTestRunResults extends Initialization {
    ...
    public Map<String, String> getTestRunResultsList(String auth_token, String token, String test_run_id) throws IOException, JSONException {
        ...
        Map<String, String> links = new GetResponse().getMapString(result, "id", "status");
        return links;
    }
    ...
    public Map<String, String>  update(String token, String auth_token, String test_run_result_id, String result_status) throws IOException, JSONException {
        ...
        String result = bodyResponse.body().string();
        if (result!=null){
            Map<String, String> result1 = new GetResponse().getMapStringFromJSON(result, "id", "status");
            return result1;
        }else {
            System.out.println("Something went wrong");
            return null;
