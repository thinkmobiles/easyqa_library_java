...
public class UpdateProject extends Initialization{
    ...
    public Map<String, String> getProjectsList(String auth_token) throws IOException, JSONException {

        Call<ResponseBody> call= easyqaUserAPI.getProjectsList(auth_token);

        Response<ResponseBody> bodyResponse = call.execute();
        String result = bodyResponse.body().string();
        Map<String, String> projects = new GetResponse().getMapString(result, "id", "title");
        return projects;
    }
    /**
