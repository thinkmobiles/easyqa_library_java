...
public class EasyQA {
     ...
     * @throws IOException for incorrect parsing of the server response
     * @throws JSONException if the server returns not Json object
     * @return string message "success" or an error
     */

    public String signOut(String token) throws IOException, JSONException {
        return new SignOut(url).signOut(token, auth_token);
    }
     ...
     * @param title the name of your organization. Should be unique
     ...
     */
    public Map<String, String> getOrganizationsList() throws IOException, JSONException {
     ...
     * @throws IOException for incorrect parsing of the server response
     * @throws JSONException if the server returns not Json object
     * @return map of Integer id and String title of the organization
     */
    public Map<String, String>  updateOrganization(String title, String organization_id, String... data) throws IOException, JSONException {
        return new UpdateOrganization(url).update(auth_token, title, organization_id, data);
    }
     ...
     */
    public Map<String, String>  getProjectsList() throws IOException, JSONException {
     ...
     */
    public Map<String, String>  getStatusesList(String token) throws IOException, JSONException {
     ...
     */
    public Map<String, String> getTestPlansList(String token) throws IOException, JSONException {
    ...
    public Map<String, String> getTestCasesListOfModule(String token, String module_id) throws IOException, JSONException {
     ...
     * @return map with ids and titles of test cases
     */
    public Map<String, String> getTestCasesListOfTestPlan(String token, String test_plan_id ) throws IOException, JSONException {
     ...
     */
    public Map<String, String> getModulesList(String token, String test_plan_id) throws IOException, JSONException {
     ...
     */
    public Map<String, String> getTestRunsList(String token) throws IOException, JSONException {
     ...
     */
    public Map<String, String>  getTestRunResultsList(String token, String test_run_id) throws IOException, JSONException {
    ...
    /**
     * Method for deleting a test run result on Test Activities page within your project in EasyQA
     * @param token of your project in EasyQA. You can generate it on Integrations page
     ...
     */
    public Map<String, String> getOrganizationRolesList(String organization_id) throws IOException, JSONException {
     ...
     * @return Map with ids and titles of organization roles
     */
    public Map<String, String> getProjectRolesList(String organization_id, String token) throws IOException, JSONException {
     ...
     * @throws JSONException if the server returns not Json object
     */
    public void updateOrganizationRoleToAdmin(String role_id) throws IOException, JSONException {
        new UpdateRoles(url).updateOrganizationRole(role_id, auth_token, "admin");
    }
     ...
     * @throws JSONException if the server returns not Json object
     */
    public void updateOrganizationRoleToUser(String role_id) throws IOException, JSONException {
        new UpdateRoles(url).updateOrganizationRole(role_id, auth_token, "user");
    }
     ...
     */
    public Map<String, String>  getIssuesList(String token) throws IOException, JSONException {
    ...
    public Integer addAttachmentToIssueByUniqueID(String token, String id, ArrayList<File> files) throws IOException, JSONException {
        ...
        return new IssueAttachments(url).createAttachment(token, auth_token, id , files);
    }
    ...
    public Integer addAttachmentToIssueByProjectID(String token, String id, ArrayList<File> files) throws IOException, JSONException {
        ...
        return new IssueAttachments(url).createAttachmentByIdInProject(token, auth_token, id, files);
    }
     ...
     * @return JSONObject result of the server response
     */
    public JSONObject getIssueWithMobileBuild(String token, String packageName, String buildVersionCode, String buildVersionName) throws IOException, JSONException {
     ...
     * @return JSONObject result of the server response
     */
    public JSONObject getIssueWithSite(String token, String link) throws IOException, JSONException {
     ...
     * @return JSONObject result of the server response
     */
    public JSONObject getIssueByUniqueID(String token, String id) throws IOException, JSONException {
     ...
     * @return JSONObject result of the server response
     */
    public JSONObject getIssueByProjectID(String token, String id) throws IOException, JSONException {
    ...
    public Map<String, String> updateIssueByUniqueID(String token, String id, String... data) throws IOException, JSONException {
        ...
        return new UpdateIssue(url).updateIssue(token, auth_token, id, data);
    }
     ...
     */
    public Map<String, String> getTestObjectsLinks(String token) throws IOException, JSONException {
