...
public class UpdateRoles extends Initialization {
    ...
    public Map<String, String> getOrganizationRolesList(String organization_id, String auth_token) throws IOException, JSONException {
        ...
        Map<String, String> roles = new GetResponse().getMapString(result, "id", "role");
        return roles;
    }
    ...
    public Map<String, String> getProjectRolesList(String organization_id, String auth_token, String token) throws IOException, JSONException {
    ...
    public void updateOrganizationRole(String role_id, String auth_token, String role) throws IOException, JSONException {
