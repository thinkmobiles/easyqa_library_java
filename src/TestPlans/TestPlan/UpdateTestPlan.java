...
public class UpdateTestPlan  extends Initialization {
    ...
    public Map<String, String> getTestPlansList(String auth_token, String token) throws IOException, JSONException {
     ...
     */
        ...
        public Map<String, String> update (String token, String auth_token, String test_plan_id, String title, String... data) throws IOException, JSONException {
            ...
            String result = bodyResponse.body().string();
            if (result!=null){
                Map<String, String> plan = new GetResponse().getMapStringFromJSON(result, "id", "title");
                return plan;
            }else {
                System.out.println("Something went wrong");
                return null;
