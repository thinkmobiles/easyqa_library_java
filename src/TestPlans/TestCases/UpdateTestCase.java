...
public class UpdateTestCase extends Initialization{
    ...
    public Map<String, String> getTestCasesListOfModule(String auth_token, String token, String module_id) throws IOException, JSONException {
        ...
        Map<String, String> links = new GetResponse().getMapString(result, "id", "title");
        return links;
    }
    ...
    public Map<String, String> getTestCasesListOfTestPlan(String auth_token, String token, String test_plan_id) throws IOException, JSONException {
    ...
    public Map<String, String> update(String token, String auth_token, String testcase_id, String... data) throws IOException, JSONException {
        ...
        Response<ResponseBody> bodyResponse = call.execute();
        String result = bodyResponse.body().string();
        Map<String, String> test_case1 = new GetResponse().getMapStringFromJSON(result, "id", "title");
        return test_case1;
    }
}
