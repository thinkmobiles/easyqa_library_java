...
public class UpdateModule extends Initialization {
    ...
    public Map<String, String>  getModulesList(String auth_token, String token, String test_plan_id) throws IOException, JSONException {
    ...
    public  Map<String, String>  update(String token, String auth_token, String module_id, String title, String... data) throws IOException, JSONException {
        ...
        String result = bodyResponse.body().string();
        System.out.println(result);
        Map<String, String> module = new GetResponse().getMapStringFromJSON(result, "id", "title");
        return module;
