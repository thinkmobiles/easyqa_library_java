...
public class UpdateStatus extends Initialization{
    ...
    public Map<String, String> getStatusesList(String auth_token, String token) throws IOException, JSONException {

        Call<ResponseBody> call= easyqaUserAPI.getStatusesList(auth_token, token);

        Response<ResponseBody> bodyResponse = call.execute();
        String result = bodyResponse.body().string();
        Map<String, String> statuses = new GetResponse().getMapString(result, "id", "name");
        return statuses;
    }
    ...
    public Map<String, String> update(String auth_token, String token, String name, String id) throws IOException, JSONException {
        ...
        String result = bodyResponse.body().string();
        if (result!=null){
            Map<String, String> status = new GetResponse().getMapStringFromJSON(result, "id", "name");
            return status;
        }else {
            System.out.println("Something went wrong");
            return null;
